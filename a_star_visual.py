...
RED = (255, 0, 0)         # Visitado
GREEN = (0, 255, 0)       # En la cola
BLUE = (64, 224, 208)     # Ruta final
YELLOW = (255, 255, 0)    # Comienzo
WHITE = (255, 255, 255)   # Camino disponible
BLACK = (0, 0, 0)         # Obstáculo
PURPLE = (128, 0, 128)    # Final
GREY = (128, 128, 128)    # Cuadrícula
